...
export default function Navbar({ onOpenSearch }: { onOpenSearch: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between border-b border-slate-200 dark:border-slate-800/80 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md px-6 shadow-xs">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        {canUndo && (
          <button
            onClick={undo}
            className="flex h-9 items-center gap-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all cursor-pointer shadow-xs"
        ...
        <button
          ...
          className="flex h-9 items-center gap-2 rounded-full border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-800/50 px-4 text-left text-xs text-slate-400 dark:text-slate-500 hover:border-blue-400 transition-all cursor-pointer w-44 sm:w-64"
        >
        ...
        <button
          onClick={toggleTheme}
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer shadow-xs transition-all"
